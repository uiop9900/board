package com.boro.board.common.annotation;
...
public class RedissonLockAop {
	private static final String REDISSON_LOCK_PREFIX = "BOARD:";

	private final RedissonClient redissonClient;

	private final AopForTransaction aopForTransaction;

	@Around("@annotation(com.boro.board.common.annotation.RedissonLock)")
	public Object lock(final ProceedingJoinPoint joinPoint) throws Throwable {
		...
		String key = REDISSON_LOCK_PREFIX + redissonLock.key() == "" ? methodName : redissonLock.key(); // REDISSON:{key}
		log.error("==============redis==============={} ", key);
